...
data_files = [
    ...
    ("/usr/share/mx-night-light/ui",
     ["ui/MainWindow.glade"]),
    ("/usr/share/mx-night-light/src",
     ["src/Main.py",
      "src/MainWindow.py",
      "src/UserSettings.py",
      "src/__version__"]),
    ("/usr/share/mx-night-light/data",
     ["data/style.css",
      ...
      "data/redshift.svg",
      "data/redshift-status-on.svg",
      "data/redshift-status-off.svg"]),
    ("/usr/share/mx-night-light/native",
     ["native/mx-night-light-native.c",
      "native/Makefile"]),
...
setup(
    ...
    author="TheBSODFan",
    author_email="bsodandwsod501@gmail.com",
